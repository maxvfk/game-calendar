...
| Endfield official | `https://endfield.gryphline.com/en-us/news` and `/en-us/news/5208` | robots.txt redirected while probe required an unredirected response; no article request made | — | — | **Blocked pending redirect classification.** Follow-up probe records response status/Location before deciding whether robots may be safely read. |
