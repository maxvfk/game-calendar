...
| Endfield official | `https://endfield.gryphline.com/en-us/news` and `/en-us/news/5208` | robots.txt redirected while probe required an unredirected response; no article request made | — | — | **Blocked pending robots validation.** Follow-up below identified a same-origin localized robots path. |
