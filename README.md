...
проверка того refresh осталась красной из-за семи недоступных Game8 fallback.
Эти семь pollers и заблокированный Fandom теперь выведены из штатного опроса;
их парсеры сохранены для локальной диагностики. Охват остаётся частичным:
если источник недоступен или дата не подтверждена, она не
